...
export function explicitAccessLevels(accessLevels) {
...
export function menuAccessFromLevels(accessLevels) {
...
export function savedMenuAccess(record) {
...
export function getVisibleNavigationItems(user) {
    const allItems = [
        ...
        { label: 'Expenses', href: '/expenses', group: 'TRANSACTIONS' },
...
function getNavigationPermission(href) {
    ...
    if (href === '/expenses') return 'expenses'
